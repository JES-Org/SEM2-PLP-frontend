...
const Page = () => {
	...
	return (
		<div>
			...
			<div className='container min-h-screen rounded-t-full mt-10'>
				<div className='md:flex justify-around pt-4 md:pt-0 md:pl-60'>
					<div className='md:flex flex-col md:ml-0 ml-3 items-start mb-2 space-y-2 md:space-y-0'>
					...
					<div className='md:flex flex-col md:ml-0 ml-3 items-start mb-8 space-y-2 md:space-y-0'>
						<NonEditableProfileFields
							ProfileFieldItems={{
								icon: <Calendar />,
								text: 'Email',
				...
				<div className='flex flex-col md:flex-row justify-center items-center gap-4 mt-10 w-full'>
					<Button className='w-1/2 md:w-2/12' onClick={handleSubmit}>
						Edit
					</Button>
